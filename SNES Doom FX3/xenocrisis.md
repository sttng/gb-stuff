...
|-----------------------------|--------------|
| bus init                    | `0x10066D94` |
| FIFO flush                  | `0x100670CC` |
| wait TX idle                | `0x10067188` |
| send code buffer (TX DMA)   | `0x100671A4` |
| recv with timeout (RX ring) | `0x100671F4` |
| direct FIFO push            | `0x10067274` |
| RX DMA IRQ                  | `0x20000980` |
